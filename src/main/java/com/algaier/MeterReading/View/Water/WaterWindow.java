...
public class WaterWindow extends Window {
    ...
    public WaterWindow(ResourceBundle messages, DBConnect dbConnection) {
        ...
        menuButton.createButtons(MENU_BUTTON_POS_X, MENU_BUTTON_POS_Y, MENU_BUTTON_POS_WIDTH, MENU_BUTTON_POS_HEIGHT, MENU_BUTTON_POS_DISTANCE, buttonNames, MENU_BUTTON_IDS, MENU_BUTTON_POS_POSITION, waterController);
